...
async function openAtlasSourceReview(sourceId, initialReview = null, title = "Fonte do Atlas") {
  ...
  const roleLabels = { evolution: "Relação · cria cards e caminhos", reverse_origin: "Origem reversa · cria caminhos", requirement: "Requisito · anexa à rota, não cria cards", reference: "Referência · não cria cards", note: "Nota · não cria cards", unrelated: "Fora do objetivo · não cria cards" };
